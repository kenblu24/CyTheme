...
//create draggable middle
$("#mainpage > .container-fluid").addClass("nano-content");
$("#mainpage").append("<div class='nano'></div>");
$("#mainpage > .nano").append($("#mainpage > .container-fluid"));
$(".nano").nanoScroller();
...
var observer = new MutationObserver(mutationCallback); //create a new observer
